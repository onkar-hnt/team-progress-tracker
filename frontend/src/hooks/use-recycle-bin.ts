...
export function useRestoreRecord(): UseMutationResult<void, Error, BinAction> {
  ...
  return useMutation({
    ...
    onError: (error) => {
      ...
      const message = toFeatureMessage(error, 'That record could not be restored. Please try again.')
...
export function useDestroyRecord(): UseMutationResult<void, Error, BinAction> {
  ...
  return useMutation({
    ...
    onError: (error) => {
      ...
      const message = toFeatureMessage(error, 'That record could not be destroyed. Please try again.')
