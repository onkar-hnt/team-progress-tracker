...
export function AccountsPage() {
  ...
  if (!areAccountsAvailable()) {
    return (
      <PagePlaceholder
        description="Logins are issued by the application API, which is not configured in this build. Set VITE_API_BASE_URL to the gateway address to administer them."
