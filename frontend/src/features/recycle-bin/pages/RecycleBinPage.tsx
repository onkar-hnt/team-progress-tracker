...
export function RecycleBinPage() {
  ...
  if (!isRecycleBinAvailable()) {
    return (
      <PagePlaceholder
        description="Recently deleted records are read from the application API. Until VITE_API_BASE_URL points at a running gateway there is nothing for this screen to list."
